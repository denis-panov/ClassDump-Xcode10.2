...
@interface _TtC12SourceEditor28SourceEditorSelectionDisplay : _TtCs12_SwiftObject
{
    ...
    // Error parsing type: , name: cursorBlinkRate_animated
    // Error parsing type: , name: cursorBlinkRate_static
    // Error parsing type: , name: cursorFadeInDuration
    // Error parsing type: , name: cursorFadeOutDuration
