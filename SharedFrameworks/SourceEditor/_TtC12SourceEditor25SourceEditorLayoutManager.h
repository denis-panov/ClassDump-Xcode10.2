...
@interface _TtC12SourceEditor25SourceEditorLayoutManager : _TtCs12_SwiftObject
{
    ...
    // Error parsing type: , name: _defaultDisplayStringAttributes
    // Error parsing type: , name: _defaultPasteboardStringAttributes
    ...
    // Error parsing type: , name: textAttributeOverrideProviders
    // Error parsing type: , name: lineHighlightOverrideProviders
    // Error parsing type: , name: columnShiftOverrideProviders
