...
@class DVTObservingToken, NSButton, NSString, NSTextField, NSTokenField, NSView, NSWindow, XCSTrigger, XCSUIBotDefinitionContext, XCSUICreateBotTriggerConditionsViewController, XCSUIScheduleViewController, XCSUITriggerCommitterOptionsViewController;
...
@interface XCSUICreateBotEmailNotificationsViewController : IDEViewController <XCSUIScheduleViewControllerDelegate, NSTokenFieldDelegate, XCSUICreateBotTriggerChildViewController>
{
    ...
    DVTObservingToken *_hostnameObserver;
