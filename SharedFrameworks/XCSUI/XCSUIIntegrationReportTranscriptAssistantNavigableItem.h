...
#import <XCSUI/IDEGeniusResultNavigableRepresentedObject-Protocol.h>
...
@interface XCSUIIntegrationReportTranscriptAssistantNavigableItem : NSObject <IDEKeyDrivenNavigableItemRepresentedObject, IDEGeniusResultNavigableRepresentedObject>
{
    NSString *_name;
...
- (id)initWithName:(id)arg1 originalFileURL:(id)arg2 generatedContentLocation:(id)arg3 type:(id)arg4 testIdentifier:(id)arg5;
