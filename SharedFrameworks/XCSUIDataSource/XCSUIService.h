...
@class NSArray, NSError, NSString, NSTimer, NSURL, XCSService, XCSUIBuildAgent, XCSUIDataSource, XCSUIIntegration, XCSUIIntegrationStatus;
...
@interface XCSUIService : NSObject <XCSUIDataSourceSnapshotsObserver, XCSUISnapshot, XCSServiceErrorDelegate>
{
    ...
    BOOL _hasFetchedRunningIntegrationStatus;
...
@property(readonly, nonatomic) XCSUIIntegration *mostRecentIntegration;
