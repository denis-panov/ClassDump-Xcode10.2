...
- (id)initWithXmlNodePtr:(struct _xmlNode *)arg1 includingChildrenFrom:(struct _xmlNode *)arg2 upToChild:(struct _xmlNode *)arg3 error:(id *)arg4;
- (id)initWithXmlNodePtr:(struct _xmlNode *)arg1 error:(id *)arg2;
