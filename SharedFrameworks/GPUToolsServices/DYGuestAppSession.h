...
@class DYBreakpoint, DYCaptureSession, DYDevice, DYFuture, DYGuestApp, DYGuestAppControlStrategy, DYGuestAppLaunchStrategy, DYResourceStreamer, DYShaderDebuggerDataSourceProviderDelegate, DYSymbolicator, DYTransport, DYTransportSource, NSDictionary, NSError, NSMapTable, NSMutableArray, NSMutableDictionary;
