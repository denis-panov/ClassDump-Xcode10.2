...
#import <XCBuild/_TtP7XCBuild24XCBTaskExecutionDelegate_-Protocol.h>
#import <XCBuild/_TtP7XCBuild27XCBTaskConstructionDelegate_-Protocol.h>
#import <XCBuild/_TtP7XCBuild28XCBPlanningOperationDelegate_-Protocol.h>

@class NSData, NSDictionary, NSString, _TtC7XCBuild17XCBBuildOperation, _TtC7XCBuild25XCBBuildOperationTaskInfo, _TtC7XCBuild27XCBBuildOperationTargetInfo, _TtC7XCBuild28XCBBuildOperationTaskMetrics, _TtC7XCBuild31XCBBuildOperationDiagnosticInfo;
...
- (void)buildOperation:(_TtC7XCBuild17XCBBuildOperation *)arg1 didUpdateProgressMessage:(NSString *)arg2 forTargetName:(NSString *)arg3 percentComplete:(double)arg4 showInLog:(BOOL)arg5;
...
- (void)buildOperationDidEnd:(_TtC7XCBuild17XCBBuildOperation *)arg1 metricsData:(NSData *)arg2;
- (void)buildOperationDidStart:(_TtC7XCBuild17XCBBuildOperation *)arg1;
- (void)buildOperation:(_TtC7XCBuild17XCBBuildOperation *)arg1 didReportCopiedPathMap:(NSDictionary *)arg2 generatedFilesPathMap:(NSDictionary *)arg3;
...
@optional
- (void)buildOperation:(_TtC7XCBuild17XCBBuildOperation *)arg1 didEndTask:(NSString *)arg2 result:(long long)arg3 signalled:(BOOL)arg4 metrics:(_TtC7XCBuild28XCBBuildOperationTaskMetrics *)arg5;
