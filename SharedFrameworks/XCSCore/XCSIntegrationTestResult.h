...
- (id)testResultWithDevice:(id)arg1 keyPath:(id)arg2 date:(id)arg3 startTime:(double)arg4 endTime:(double)arg5 duration:(double)arg6 passed:(BOOL)arg7 failureSummaries:(id)arg8 testableBlueprintPath:(id)arg9 testableBlueprintName:(id)arg10 validationErrors:(id *)arg11;
