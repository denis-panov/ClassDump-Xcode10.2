...
+ (id)testResultWithIntegrationTestResult:(id)arg1 device:(id)arg2 keyPath:(id)arg3 date:(id)arg4 startTime:(double)arg5 endTime:(double)arg6 duration:(double)arg7 passed:(BOOL)arg8 failureSummaries:(id)arg9 testableBlueprintPath:(id)arg10 testableBlueprintName:(id)arg11 validationErrors:(id *)arg12;
...
- (id)description;
- (id)initWithDevice:(id)arg1 keyPath:(id)arg2 date:(id)arg3 startTime:(double)arg4 endTime:(double)arg5 duration:(double)arg6 passed:(BOOL)arg7 failureSummaries:(id)arg8 testableBlueprintPath:(id)arg9 testableBlueprintName:(id)arg10 validationErrors:(id *)arg11;
