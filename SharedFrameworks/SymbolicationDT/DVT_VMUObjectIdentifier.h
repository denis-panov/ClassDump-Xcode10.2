...
@class DVT_VMUClassInfo, DVT_VMUClassInfoMap, DVT_VMUNonOverlappingRangeArray, DVT_VMUSwiftRuntimeInfo, DVT_VMUTaskMemoryScanner, NSHashTable, NSMapTable, NSMutableDictionary, NSMutableSet;
