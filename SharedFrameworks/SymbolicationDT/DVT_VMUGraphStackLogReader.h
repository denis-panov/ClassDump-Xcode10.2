...
@class DVT_VMUDebugTimer, DVT_VMUProcessObjectGraph, DVT_VMURangeToStringMap, DVT_VMUVMRegionTracker, NSSet, NSString;

@interface DVT_VMUGraphStackLogReader : DVT_VMUStackLogReaderBase <NSSecureCoding, VMUStackLogReader>
{
