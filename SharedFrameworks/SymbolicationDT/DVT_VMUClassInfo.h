...
@property(readonly, nonatomic) DVT_VMUClassInfo *superclassInfo; // @synthesize superclassInfo=_superclassLayout;
...
@property(readonly, nonatomic) DVT_VMUClassInfo *genericInfo;
