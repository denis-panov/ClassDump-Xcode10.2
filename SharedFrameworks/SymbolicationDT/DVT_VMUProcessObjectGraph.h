...
@class DVT_VMUClassInfoMap, DVT_VMUDebugTimer, DVT_VMUGraphStackLogReader, DVT_VMUNodeToStringMap, DVT_VMURangeToStringMap, NSArray, NSDictionary, NSString;
...
@interface DVT_VMUProcessObjectGraph : DVT_VMUObjectGraph <VMUCommonGraphInterface>
{
    ...
    void *_userMarked;
    DVT_VMUGraphStackLogReader *_stackLogReader;
