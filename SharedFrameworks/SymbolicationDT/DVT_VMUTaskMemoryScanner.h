...
@interface DVT_VMUTaskMemoryScanner : NSObject <VMUCommonGraphInterface>
{
    ...
    DVT_VMURangeArray *_dataSegmentsRangeArrayOutsideSharedCache;
...
@property(readonly, nonatomic) DVT_VMUTaskMemoryCache *memoryCache; // @synthesize memoryCache=_memoryCache;
