...
@class DVT_VMUMutableClassInfo;

@interface DVT_VMUSwiftRuntimeInfo : NSObject
{
    ...
    DVT_VMUMutableClassInfo *_sideTableLayout;
    DVT_VMUMutableClassInfo *_unownedExtraDataLayout;
...
@property(readonly, nonatomic) DVT_VMUMutableClassInfo *unownedExtraDataLayout; // @synthesize unownedExtraDataLayout=_unownedExtraDataLayout;
@property(readonly, nonatomic) DVT_VMUMutableClassInfo *sideTableLayout; // @synthesize sideTableLayout=_sideTableLayout;
