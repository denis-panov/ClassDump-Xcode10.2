...
@class DTDKRemoteDeviceConnection, DTDKRemoteDeviceConsoleController, DTDKTCPRelayServiceClient, DVTDispatchLock, DVTFuture, DVTNotificationToken, DVTPlatform, NSArray, NSError, NSMutableArray, NSNumber, NSObject, NSSet, NSString;
...
@interface DTDKMobileDeviceToken : DTDKDeviceTokenBase
{
    ...
    NSObject<OS_dispatch_queue> *_developerDiskImageMountQueue;
    ...
    DTDKTCPRelayServiceClient *_tcpRelayServiceclient;
...
@property(retain) DVTFuture *startSecureServicesOp; // @synthesize startSecureServicesOp=_startSecureServicesOp;
@property(retain, nonatomic) DTDKTCPRelayServiceClient *tcpRelayServiceClient; // @synthesize tcpRelayServiceClient=_tcpRelayServiceclient;
...
- (void)_updatePrimaryConnectionWithCompletion:(CDUnknownBlockType)arg1;
