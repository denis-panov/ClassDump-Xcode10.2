...
#import <IDEFoundation/IDEConstraintErrorBreakpoint.h>
...
@interface IDEConstraintErrorBreakpoint (IDEBreakpointNavigatorSupport) <IDEKeyDrivenNavigableItemRepresentedObject>
