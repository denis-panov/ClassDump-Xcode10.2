...
#import <IDEFoundation/IDESwiftErrorBreakpoint.h>
...
@interface IDESwiftErrorBreakpoint (IDEBreakpointNavigatorSupport) <IDEKeyDrivenNavigableItemRepresentedObject>
