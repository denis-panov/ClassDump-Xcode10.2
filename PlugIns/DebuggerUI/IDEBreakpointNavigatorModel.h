...
@class DVTDocumentLocation, DVTFileDataType, DVTObservingToken, DVTStackBacktrace, IDEFileReference, IDEWorkspace, NSArray, NSImage, NSMutableArray, NSMutableSet, NSNull, NSString, NSURL, _TtC13DVTFoundation9DVTSymbol;
