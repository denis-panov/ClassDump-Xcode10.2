...
#import <IDEIntentBuilderCore/IDEIntentBuilderIntentResponse.h>
...
@interface IDEIntentBuilderIntentResponse (EditorAdditions) <IDEKeyDrivenNavigableItemRepresentedObject>
