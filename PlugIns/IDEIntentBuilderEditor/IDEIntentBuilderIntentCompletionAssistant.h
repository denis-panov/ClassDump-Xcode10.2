...
#import <IDEIntentBuilderEditor/NSOpenSavePanelDelegate-Protocol.h>

@class NSString;

@interface IDEIntentBuilderIntentCompletionAssistant : Xcode3FileTemplateCompletionAssistant <NSOpenSavePanelDelegate>
{
...
- (void)_configureDataSourceFileTypes;
