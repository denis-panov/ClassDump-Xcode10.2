...
#import <IDEPlaygroundEditor/NSPopoverDelegate-Protocol.h>

@class DVTGradientImageButton, DVTNotificationToken, DVTObservingToken, IDELoggerDrivenValueHistoryToy, IDEPlaygroundQuickLookController, IDEPlaygroundQuickLookPopover, IDESourceCodePlaygroundSection, IDESourceCodePlaygroundSectionAccessoryViewAnnotation, IDEToyHostingViewController, NSButton, NSFont, NSLayoutConstraint, NSMutableArray, NSString, NSView, _IDESourceCodePlaygroundSectionAnnotationView;
...
@interface IDESourceCodePlaygroundSectionAnnotationViewController : DVTViewController <NSPopoverDelegate>
{
    ...
    NSLayoutConstraint *_valueHistoryButtonRightEdgeConstraint;
    NSMutableArray *_quickLookButtonHiddenConstraints;
    NSMutableArray *_quickLookButtonVisibleConstraints;
    ...
    NSView *_quickLookLabel;
    NSButton *_quickLookButton;
    DVTGradientImageButton *_valueHistoryButton;
...
@property(readonly) NSView *quickLookLabel; // @synthesize quickLookLabel=_quickLookLabel;
...
- (id)_quickLookImage;
- (void)_updateQuickLookButtonVisibility;
- (void)_updateCurrentDisplayState;
- (void)_updateValueHistoryButtonIsConnected:(BOOL)arg1;
- (id)_connectedValueHistoryButtonImage;
- (id)_disconnectedValueHistoryButtonImage;
- (void)_quickLookButtonAction:(id)arg1;
- (void)_notifyInteractionDelegateDidToggleInlineResultsVisibility:(BOOL)arg1;
