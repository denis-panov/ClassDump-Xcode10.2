...
@class IDEPlaygroundLayoutManager, IDEPlaygroundTextContainer, IDESourceCodePlaygroundSectionAnnotationViewController, IDEToybox, NSMapTable;
...
- (void)renderDocumentationSections:(BOOL)arg1;
