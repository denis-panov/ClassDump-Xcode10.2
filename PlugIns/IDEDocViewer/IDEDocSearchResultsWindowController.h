...
@class DVTPerformanceMetric, DVTScopeBarView, DVTTableView, IDEDocSearchQuery, IDEReferenceDocumentationInfo, NSArray, NSMutableDictionary, NSStackView, NSString, NSTrackingArea;
...
@interface IDEDocSearchResultsWindowController : NSWindowController <NSTableViewDataSource, NSTableViewDelegate>
{
    ...
    IDEReferenceDocumentationInfo *_selectedReference;
