...
@class IDEReferenceDocumentationInfo, NSString;

@interface IDEDocSearchQuery : NSObject
{
    NSString *_searchString;
    unsigned long long _matchType;
    IDEReferenceDocumentationInfo *_reference;
...
- (id)description;
- (id)initWithSearchString:(id)arg1 matchType:(unsigned long long)arg2 reference:(id)arg3 tokenScope:(id)arg4;
