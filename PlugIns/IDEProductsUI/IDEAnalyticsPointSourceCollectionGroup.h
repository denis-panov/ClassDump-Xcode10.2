...
#import <IDEProductsUI/IDEKeyDrivenNavigableItemRepresentedObject-Protocol.h>
...
@interface IDEAnalyticsPointSourceCollectionGroup : NSObject <IDEKeyDrivenNavigableItemRepresentedObject>
{
    NSArray *_analyticsPointSourceCollections;
    NSString *_name;
    long long _type;
}
