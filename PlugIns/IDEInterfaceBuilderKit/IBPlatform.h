...
@interface IBPlatform : NSObject <IBScopedSingleton>
{
    ...
    NSSet *_buildEnvironmentVerifierExtensions;
...
+ (id)platformForBuildSystemPlatformIdentifier:(id)arg1 sdkVariant:(id)arg2;
+ (id)platformForBuildSystemPlatformIdentifier:(id)arg1;
+ (id)platformForBuildSystemPlatformName:(id)arg1 sdkVariant:(id)arg2;
...
- (void)populateIssues:(id)arg1 forObject:(id)arg2 inDocument:(id)arg3 withComputationContext:(id)arg4;
...
- (id)buildEnvironmentVerifierExtensions;
