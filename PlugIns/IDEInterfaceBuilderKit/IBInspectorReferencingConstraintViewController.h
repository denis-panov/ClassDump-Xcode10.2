...
@class IBDocument, IBDocumentMemberWrapper, IBLayoutConstraint, NSArray, NSObject, NSString;
...
@interface IBInspectorReferencingConstraintViewController : DVTViewController <IBInspectorReferencingConstraintViewDelegate>
{
    ...
    NSObject<IBAutolayoutItem> *_referencedItem;
...
- (unsigned long long)referencedItemAttribute;
...
- (id)initWithConstraint:(id)arg1 referencingItem:(id)arg2;
