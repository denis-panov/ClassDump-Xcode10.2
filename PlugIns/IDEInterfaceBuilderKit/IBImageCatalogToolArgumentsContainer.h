...
@interface IBImageCatalogToolArgumentsContainer : IBArgumentsContainer
{
    ...
    NSString *_generatedSourcePath;
    NSString *_generatedSourceLanguages;
    NSString *_generatedSourceVersion;
...
@property(copy) NSString *generatedSourceVersion; // @synthesize generatedSourceVersion=_generatedSourceVersion;
@property(copy) NSString *generatedSourceLanguages; // @synthesize generatedSourceLanguages=_generatedSourceLanguages;
@property(copy) NSString *generatedSourcePath; // @synthesize generatedSourcePath=_generatedSourcePath;
