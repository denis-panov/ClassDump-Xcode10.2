...
@class DVTDelayedInvocation, DVTStackBacktrace, IBAbstractDocumentEditor, IBActionForwardingResponder, IBCancellationToken, IBCanvasViewController, IBDelegatedCanvasOverlay, IBDeviceBezel, IBDeviceConfiguration, IBDocument, IBEditor, IBEditorCanvasFrame, IBFieldEditor, IBHitDetectionMap, IBInlineStringEditingContext, IBInvalidationToken, IBLayoutManager, IBMemberConfiguration, IBNavigationMenuController, IBTargetIdentifier, NSAccessibilityElement, NSDate, NSEvent, NSMutableDictionary, NSMutableSet, NSSet, NSString;
...
@interface IBEditorCanvasFrameController : NSObject <IBDelegatedCanvasOverlayDelegate, IBEndPointProvider, NSUserInterfaceValidations, NSDraggingDestination, IBDocumentArbitrationResponder, DVTInvalidation>
{
    ...
    DVTDelayedInvocation *_removeTargetIdentifierInvocation;
...
- (id)_makeFullSceneUpdateRequestForRoot:(id)arg1 withObjectPackage:(id)arg2 document:(id)arg3;
