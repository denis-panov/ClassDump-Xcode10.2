...
- (void)ibInvalidateReferencedInstalledConstraintsAfterChangingRelationship:(id)arg1 includingChildren:(BOOL)arg2;
...
- (void)ibInvalidateCachedInstalledConstraintsWithAncestors;
...
- (id)ibViewFromPasteboardImage:(id)arg1 inDocument:(id)arg2;
...
- (void)ibPopulateIssues:(id)arg1 forAmbiguityInOrientations:(unsigned long long)arg2 withAutolayoutStatus:(id)arg3 inDocument:(id)arg4 context:(id)arg5;
- (void)ibPopulateIssues:(id)arg1 forMisplacementWithAutolayoutStatus:(id)arg2;
- (BOOL)ibShouldCoalesceAmbiguityWarningsForAutolayoutStatus:(id)arg1;
- (void)ibPopulateIssues:(id)arg1 forDocument:(id)arg2 withComputationContext:(id)arg3;
- (id)ibIssueMessageForLocalizationWarningType:(long long)arg1;
...
- (void)ibPopulateIssues:(id)arg1 forLocalizationIssuesInDocument:(id)arg2;
...
- (void)ibPopulateIssues:(id)arg1 forOverlappingViewsForSibling:(id)arg2 withParentView:(id)arg3 inDocument:(id)arg4 withComputationContext:(id)arg5;
- (BOOL)ibShouldPopulateIssuesForOverlappingViewsInDocument:(id)arg1;
...
- (void)setIbFrameAsExplicitlyMisplaced;
...
- (BOOL)ibShadowedSubviewsContainsObject:(id)arg1;
@property(readonly, nonatomic) NSView *ibShadowedSubviewsFirstView;
