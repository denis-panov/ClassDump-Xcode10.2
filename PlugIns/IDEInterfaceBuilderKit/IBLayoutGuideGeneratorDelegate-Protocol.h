...
- (BOOL)layoutGuideGenerator:(IBLayoutGuideGenerator *)arg1 isEdge:(unsigned int)arg2 ofAncestor:(NSObject<IBAutolayoutItem> *)arg3 fixedDuringResizingOfSubviews:(id <IBCollection>)arg4 fromKnob:(CDUnion_31865a80)arg5;
- (BOOL)layoutGuideGenerator:(IBLayoutGuideGenerator *)arg1 isEdge:(unsigned int)arg2 ofSubview:(NSObject<IBAutolayoutItem> *)arg3 fixedInPositionOnWindowDuringResizeFromKnob:(CDUnion_31865a80)arg4;
- (BOOL)layoutGuideGenerator:(IBLayoutGuideGenerator *)arg1 isDistanceFromSubviewEdge:(unsigned int)arg2 ofSubview:(NSObject<IBAutolayoutItem> *)arg3 toSameEdgeOfSuperviewChangingOneToOneWithKnob:(CDUnion_31865a80)arg4;
...
- (NSArray *)layoutGuideGenerator:(IBLayoutGuideGenerator *)arg1 baselinesForViews:(id <IBCollection>)arg2 withSuggestedLayoutFrame:(struct CGRect)arg3 andKnobPosition:(CDUnion_31865a80)arg4;
