...
#import <IBAutolayoutFoundation/IBLayoutGuideGeneratorDelegate.h>
...
- (void)addBaselinesForResizingSingleView:(id)arg1 toArray:(id)arg2 fromKnob:(CDUnion_31865a80)arg3 withUnalignedSelectionFrame:(struct CGRect)arg4 coordinateSpaceView:(id)arg5;
