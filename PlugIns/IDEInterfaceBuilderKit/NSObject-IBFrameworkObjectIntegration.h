...
+ (BOOL)ibSupportsConfigurationInstallRelationshipCachingVerification;
+ (BOOL)ibSupportsConfigurationInstallRelationshipCaching;
...
+ (id)keyPathsForValuesAffectingIbInspectedLocalizationComment;
...
+ (id)ibSearchableInspectorSlicesForCategory:(id)arg1 idiom:(id)arg2;
...
@property(copy, nonatomic) IBDesignablesStatus *ibInspectedDesignablesStatus;
...
- (id)ibAllPropertiesForInheritableMetricsInvalidationStartingWithClass:(Class)arg1;
- (id)ibAllPropertiesForInheritableMetricsInvalidation;
...
@property(retain, nonatomic) NSArray *ibAutolayoutStatusComputationWarningMessages;
@property(retain, nonatomic) NSError *ibAutolayoutStatusComputationError;
...
- (BOOL)ibAreReceiverAndAncestorsTurnedOn:(id)arg1;
- (BOOL)ibDirectAreReceiverAndAncestorsTurnedOn:(id)arg1;
- (void)ibInvalidateCachedAreReceiverAndAncestorsTurnedOnForLastConfigurationIncludingChildren:(BOOL)arg1;
- (id)ibCachedAreReceiverAndAncestorsTurnedOnConfiguration;
- (id)ibCachedAreReceiverAndAncestorsTurnedOnValue;
...
@property(copy) NSArray *ibExternalUserDefinedRuntimeAttributes;
...
@property(readonly) NSString *ibInspectedIdentityObjectID;
...
@property(readonly) BOOL ibIsPlaceholder;
- (id)ibRuntimeFormattedClassName;
- (id)ibRuntimeFormattedClassSymbol;
@property(readonly) NSString *ibRuntimeClassName;
...
@property BOOL ibExternalIdentityShowNotesWithSelection;
@property(copy) NSAttributedString *ibExternalIdentityNotes;
@property(readonly) NSString *ibEffectiveLocalizationComment;
@property(copy) NSString *ibInspectedLocalizationComment;
- (id)ibEffectiveUnformattedClassName;
- (id)ibEffectiveFormattedClassName;
- (id)ibEffectiveFormattedClassSymbol;
@property(readonly) NSString *ibEffectiveClassModule;
@property(readonly) NSString *ibEffectiveClassName;
...
@property(copy) NSString *ibExternalCustomClassModuleProvider;
@property(copy) NSString *ibExternalCustomClassModule;
@property(copy) NSString *ibExternalCustomClassName;
@property(copy) NSString *ibExternalExplicitLabel;
@property(readonly) NSString *ibEffectiveLabel;
@property(readonly) NSString *ibEffectiveOutletNameForLabel;
@property(copy) NSString *ibExternalLabelIdentifier;
...
- (id)ibAllNonUndoableDisplayOnlyKeyPathsStartingWithClass:(Class)arg1;
- (id)ibAllNonUndoableDisplayOnlyKeyPaths;
...
- (id)ibContextLabelForAttributeSearchLocation:(id)arg1 inInspectorSlices:(id)arg2 inDocument:(id)arg3;
...
- (BOOL)ibIsSearchableAttributeKeyPathVisible:(id)arg1 inInspectorSlices:(id)arg2 inDocument:(id)arg3;
...
@property(readonly) NSArray *ibSearchableActionConnections;
@property(readonly) NSArray *ibSearchableOutletConnections;
@property(readonly) NSArray *ibOneAndToManyOutletConnections;
...
@property(nonatomic) struct CGSize ibContentSizeForEditorVerification;
...
@property(readonly) BOOL ibCanChangeCustomClassName;
...
- (BOOL)isSingleChildAndTargetOfToOneRelationship:(id)arg1;
...
@property(readonly, nonatomic) NSString *ibDescriptionWithOID;
- (id)ibLabelQualifierForChild:(id)arg1;
- (id)ibLocalAdditionalIbtoolDescriptionKeyPaths;
@property(readonly) NSString *ibLoggingDescription;
@property(readonly) NSString *ibDefaultLabel;
- (id)ibIssueLabelInDocument:(id)arg1;
@property(readonly) NSString *ibQualifyingInfoForDefaultLabel;
- (BOOL)ibWantsVerboseDefaultLabel;
@property(readonly) NSString *ibTypeNameForDefaultLabel;
- (void)decodeTargetRuntime:(id)arg1;
- (void)encodeTargetRuntime:(id)arg1;
@property(retain) IBTargetRuntime *targetRuntime;
@end
