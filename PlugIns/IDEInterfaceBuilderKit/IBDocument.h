...
#import <IDEInterfaceBuilderKit/IBArchivableDocument-Protocol.h>
...
#import <IDEInterfaceBuilderKit/IBAutolayoutInfoProvider-Protocol.h>
#import <IDEInterfaceBuilderKit/IBDiagnosticsHandlerConfigurator-Protocol.h>
#import <IDEInterfaceBuilderKit/IBLiveViewsBundleObserverEnvironment-Protocol.h>
#import <IDEInterfaceBuilderKit/IBObjectContainerArchivingDelegate-Protocol.h>
#import <IDEInterfaceBuilderKit/IBObjectContainerDelegate-Protocol.h>
#import <IDEInterfaceBuilderKit/IBSceneUpdateManagerDelegate-Protocol.h>
#import <IDEInterfaceBuilderKit/IBUnarchivableDocument-Protocol.h>
#import <IDEInterfaceBuilderKit/IBXMLCoderDelegate-Protocol.h>
#import <IDEInterfaceBuilderKit/IBXMLDecoderDelegate-Protocol.h>
#import <IDEInterfaceBuilderKit/IDEDocumentStructureProviding-Protocol.h>
#import <IDEInterfaceBuilderKit/IDEMediaLibraryDelegate-Protocol.h>
...
@interface IBDocument : IDEEditorDocument <IBXMLCoderDelegate, IBXMLDecoderDelegate, IDEDocumentStructureProviding, IDENavigableItemArchivableRepresentationSupport, IDEMediaLibraryDelegate, IBAttributeSearchLocationIteratorDelegate, IBSceneUpdateManagerDelegate, IBArchivableDocument, IBUnarchivableDocument, IBObjectContainerDelegate, IBObjectContainerArchivingDelegate, IBAutolayoutInfoProvider, IBAutolayoutFrameDeciderDelegate, DVTTextFindable, DVTTextReplacable, NSKeyedUnarchiverDelegate, IBLiveViewsBundleObserverEnvironment, IBDiagnosticsHandlerConfigurator>
{
    ...
    BOOL _finishedPromptingForUpdatesAndValidations;
    BOOL _finishedShowingLoadingSpinner;
    BOOL _beganEditingWithoutShowing;
    BOOL _completedInitialUndoManagerSetup;
    NSMutableArray *_undoLifecycleBlocks;
    NSMutableSet *_parentsWithChildrenNeedingMemberWrapperInstalledStateValidation;
    NSMutableSet *_editorViewControllers;
    BOOL _haveLoadedInAtLeastOneEditorViewController;
    IDEWorkspace *_effectiveWorkspaceAtLastRefresh;
    ...
    BOOL _suspendingIssueValidation;
    IBPerformanceMetric *_editOperationPerformanceMetric;
    IBPerformanceMetric *_documentLoadingUIPerformanceMetric;
    ...
    long long _forceAutolayoutAutomaticFrameDecision;
    ...
    IBDeviceConfiguration *_initialConfigurationFromUnarchiving;
    ...
    BOOL _usesSafeAreaLayoutGuides;
    BOOL _launchScreen;
    BOOL _shouldDisplayLockedMemberAlertForNextAutomaticUndo;
    BOOL _shouldGenerateLocalizationIssues;
    ...
    NSString *_currentIBFrameworkVersion;
    NSString *_currentAppKitVersion;
...
+ (void)setIgnoreInsecureFormatPrompt:(BOOL)arg1;
+ (BOOL)ignoreInsecureFormatPrompt;
+ (void)setArgumentsContainerForCurrentBuildInvocation:(id)arg1;
+ (id)argumentsContainerForCurrentBuildInvocation;
+ (void)setApplicationPresentsInterface:(BOOL)arg1 during:(CDUnknownBlockType)arg2;
...
@property(nonatomic) BOOL shouldGenerateLocalizationIssues; // @synthesize shouldGenerateLocalizationIssues=_shouldGenerateLocalizationIssues;
...
@property(readonly, nonatomic) IBSimulatedMetricsInferrer *metricsInferrer; // @synthesize metricsInferrer=_metricsInferrer;
...
@property(retain, nonatomic) NSSet *configurationVariablesForBranching; // @synthesize configurationVariablesForBranching=_configurationVariablesForBranching;
...
- (void)performIncrementalUpdatesAndDelayAutolayoutStatusForSceneContainingObject:(id)arg1 allowIncrementalSceneUpdatesForSceneRoots:(BOOL)arg2 during:(CDUnknownBlockType)arg3;
- (void)ignoreSceneInvalidationDuring:(CDUnknownBlockType)arg1;
- (void)invalidateAllScenesForReason:(CDUnknownBlockType)arg1;
...
- (void)configureAutolayoutStatusUpdateForRequest:(id)arg1;
...
- (void)invalidateLabelForObjects:(id)arg1;
...
- (id)searchDescriptionWithFileURL:(id)arg1;
...
- (void)addUserDefinedRuntimeAttributes:(id)arg1 forObject:(id)arg2;
...
- (id)effectiveRetargetedConfigurationForRelationship:(id)arg1 object:(id)arg2 ofMember:(id)arg3;
- (void)targetConfiguration:(id)arg1 forAllEditsToAttributesAtAndBelowMember:(id)arg2 during:(CDUnknownBlockType)arg3;
...
- (id)_configurationByApplyingBranchingVariablesToConfiguration:(id)arg1 definingConfiguration:(id)arg2;
...
- (void)noteConfigurationPropertyForwardingDirection:(long long)arg1 during:(CDUnknownBlockType)arg2;
...
- (void)invalidateChildMemberWrapperInstalledStateIfNeededAfterObservingChangeToObject:(id)arg1 forProperty:(id)arg2;
- (void)createConfigurationPropertyStoragesForAllObjects;
- (void)createConfigurationPropertyStorageIfNeededForObject:(id)arg1;
- (id)configurationPropertyStorageForObject:(id)arg1;
- (id)defaultDeviceSubtype;
- (id)deviceSubtypes;
...
- (void)convertConstraintsToUseSafeArea:(BOOL)arg1;
- (BOOL)supportsSafeAreaLayoutGuides;
- (void)enableSafeAreaLayoutGuides:(BOOL)arg1;
- (void)setUsesSafeAreaLayoutGuides:(BOOL)arg1;
- (id)documentMetrics;
- (void)documentLoadingUIPerformanceMetricStop;
- (void)documentLoadingUIPerformanceMetricCheckpoint:(id)arg1;
- (void)documentLoadingUIPerformanceMetricStart;
- (void)documentEditorSessionMetricStop;
- (void)documentEditorSessionMetricStart;
- (void)clearAndAddAllSuggestedConstraintsFromSource:(long long)arg1;
- (void)clearAndAddSuggestedConstraintsForItems:(id)arg1 fromSource:(long long)arg2;
- (void)addMissingConstraintsForAmbiguousAndMisplacedItems;
- (void)addMissingConstraintsForItems:(id)arg1;
- (void)clearConstraintsForItems:(id)arg1 fromSource:(long long)arg2;
- (id)candidateConstraintsForItems:(id)arg1;
...
- (BOOL)prepareToEditWithoutShowing;
- (void)attemptToUpdateToLatestFormatIfNeededOptionallyRunningImmediatelyWithoutPrompt:(BOOL)arg1;
- (BOOL)alreadyShowingUpgradeDocumentAlert;
- (void)completeUpgradeWithDeviceSubtype:(id)arg1;
- (id)alertForUpgradeReturningDeviceButton:(id *)arg1;
...
- (void)forceAutolayoutAutomaticFrameDecisionDuring:(CDUnknownBlockType)arg1;
- (BOOL)allowsAutolayoutAutomaticFrameDecision;
...
- (void)fontsObserverDidUpdatedFilePaths:(id)arg1 andRemovedFilePaths:(id)arg2;
- (void)documentObserverDidUpdatedFilePaths:(id)arg1 andRemovedFilePaths:(id)arg2;
...
- (id)nameForDocumentColor:(id)arg1;
...
- (BOOL)developmentTargetIsAtLeastXcode5;
- (BOOL)developmentTargetIsAtLeast:(long long)arg1;
...
- (id)observeDocumentDependency:(id)arg1 withObserver:(CDUnknownBlockType)arg2;
...
- (void)stopObservingNonUndoableDisplayOnlyPropertiesOfObject:(id)arg1;
- (void)startObservingNonUndoableDisplayOnlyPropertiesOfObject:(id)arg1;
- (void)stopUndoObservationsOf:(id)arg1;
- (void)startUndoObservationsOf:(id)arg1;
- (void)enumerateNonUndoableDisplayOnlyPropertyKeyPathsForObject:(id)arg1 withBlock:(CDUnknownBlockType)arg2;
- (void)enumerateUndoableKeyPathsForMember:(id)arg1 withBlock:(CDUnknownBlockType)arg2;
...
- (void)invokeWithPasteboardCloneOfObject:(id)arg1 context:(id)arg2 forPasteboardOperationType:(long long)arg3 block:(CDUnknownBlockType)arg4;
- (void)invokeWithPasteboardCloneOfObject:(id)arg1 context:(id)arg2 block:(CDUnknownBlockType)arg3;
...
- (void)invokeWithPasteboardCloneOfObjects:(id)arg1 documentClass:(Class)arg2 documentType:(id)arg3 context:(id)arg4 block:(CDUnknownBlockType)arg5;
- (void)invokeWithPasteboardCloneOfObjects:(id)arg1 documentClass:(Class)arg2 documentType:(id)arg3 context:(id)arg4 forPasteboardOperationType:(long long)arg5 block:(CDUnknownBlockType)arg6;
...
- (void)putObjects:(id)arg1 onPasteboard:(id)arg2 forPasteboardOperationType:(long long)arg3;
- (void)putObjects:(id)arg1 onPasteboard:(id)arg2 context:(id)arg3 forPasteboardOperationType:(long long)arg4;
...
- (id)refactoringModificationsForRenameRefactoringRequest:(id)arg1;
...
- (void)populateGlobalIssues:(id)arg1;
...
- (BOOL)applyStringsFileAtPath:(id)arg1 context:(id)arg2 frameDecide:(BOOL)arg3 error:(id *)arg4;
- (BOOL)applyStrings:(id)arg1 withFileNameHint:(id)arg2 context:(id)arg3 frameDecide:(BOOL)arg4 error:(id *)arg5;
...
- (void)scheduleEndEditingBlockWithBehaviorInAbscenceOfUndoManager:(long long)arg1 block:(CDUnknownBlockType)arg2;
- (void)disableGroupingUndoActionsByEventDuring:(CDUnknownBlockType)arg1;
- (void)groupUndoActionsDuring:(CDUnknownBlockType)arg1;
- (void)noteChange:(id)arg1;
- (void)_noteConfigurationPropertyMember:(id)arg1 didChangeProperty:(id)arg2 fromValue:(id)arg3;
- (void)invalidateIssuesAfterObject:(id)arg1 changedProperty:(id)arg2 fromValue:(id)arg3;
...
- (id)displayGroupedPrototypeConnectionsFromObject:(id)arg1 toObject:(id)arg2;
- (id)displayGroupedPrototypeConnectionsForObject:(id)arg1;
...
- (BOOL)_canRemoveOrTurnOffObjects:(id)arg1 withHandler:(CDUnknownBlockType)arg2;
...
- (Class)compilerClass;
- (id)debugVersionDescriptionWithObjectContainer:(id)arg1;
...
- (void)objectContainer:(id)arg1 willReorderConnection:(id)arg2 toIndex:(long long)arg3;
...
- (void)notifyGroupWrappersOfReorderedConnection:(id)arg1;
...
- (void)memberWrapperWillInvalidate:(id)arg1;
...
- (void)setLiveViewsManager:(id)arg1;
- (id)liveViewsManager;
- (BOOL)hasAnyActiveLiveViews;
...
- (CDUnknownBlockType)xmlCoder:(id)arg1 comparatorForCollection:(id)arg2;
...
- (id)documentArchiver:(id)arg1 errorForArchivingIssues:(id)arg2;
- (id)documentArchiver:(id)arg1 issueTextForUnknownEnumeratedValue:(long long)arg2 fromEnumeration:(id)arg3 forKey:(id)arg4;
...
- (void)unarchiveDocumentDeviceConfigurationWithDocumentUnarchiver:(id)arg1;
...
- (void)populateRequiredDocumentCapabilities:(id)arg1 forArchiver:(id)arg2;
...
- (BOOL)_shouldOpenInsecureFileAtURL:(id)arg1 error:(id *)arg2;
...
- (void)disableSavingWithError:(id)arg1 whileRunningBlock:(CDUnknownBlockType)arg2;
...
- (void)ibReportDocumentUsageMetrics:(id)arg1;
- (BOOL)generateSourceFileAtPath:(id)arg1 sourceLanguages:(id)arg2 sourceGenerationVersion:(id)arg3 documentName:(id)arg4 outError:(id *)arg5;
- (id)ibDocumentTree;
