...
- (void)archiveIBDirectionalEdgeInsets:(struct NSDirectionalEdgeInsets)arg1 forKey:(id)arg2 defaultValue:(struct NSDirectionalEdgeInsets)arg3;
...
- (void)archiveIBDirectionalEdgeInsets:(struct NSDirectionalEdgeInsets)arg1 forKey:(id)arg2;
