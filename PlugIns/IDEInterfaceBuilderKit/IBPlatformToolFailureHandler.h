...
@class DVTStackBacktrace, IBDiagnosticsHandler, IBPlatformToolFailure, IBPlatformToolFailureContext, NSDate;
...
+ (void)performRequestWithTool:(id)arg1 failureHandlerBlock:(CDUnknownBlockType)arg2 failureMessageBlock:(CDUnknownBlockType)arg3 diagnosticsConfigurationBlock:(CDUnknownBlockType)arg4 duringBlock:(CDUnknownBlockType)arg5;
