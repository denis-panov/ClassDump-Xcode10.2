...
#import <IDEQuickHelp/DVTTextCompletionItemInfoProvider-Protocol.h>

@interface IDEQuickHelpIndexCompletionItemInfoProvider : NSObject <DVTTextCompletionItemInfoProvider>
{
}

- (id)_completionControllerWithAltContent:(id)arg1 width:(double)arg2 completionBlock:(CDUnknownBlockType)arg3;
