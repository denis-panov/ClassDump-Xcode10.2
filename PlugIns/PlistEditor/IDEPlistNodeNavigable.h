...
@class DVTDocumentLocation, DVTFileDataType, DVTPlistNode, IDEFileReference, IDEPlistDocument, NSArray, NSImage, NSNull, NSString, NSURL, _TtC13DVTFoundation9DVTSymbol;
