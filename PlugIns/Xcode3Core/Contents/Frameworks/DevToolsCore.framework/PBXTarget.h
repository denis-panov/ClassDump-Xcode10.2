...
@interface PBXTarget : PBXProjectItem <XCCompatibilityChecking, XCConfigurationInspectables, XCConfigurationListOwners>
{
    ...
    id <DVTInvalidation> _projectReferenceDidSynchronizeNotificationObservingToken;
...
- (void)_setPackageProductDependencies:(id)arg1;
...
- (void)_postBlueprintDidChangeNotificationAndSpecificNotification:(id)arg1 userInfo:(id)arg2;
- (void)invalidate;
- (void)willChange;
...
- (id)pathToAssetCatalogAppIconWithTargetWidth:(double)arg1 passingTest:(CDUnknownBlockType)arg2;
- (id)pathToLargestAssetCatalogAppIconPassingTest:(CDUnknownBlockType)arg1;
- (double)widthForIconEntry:(id)arg1;
- (void)enumerateAssetCatalogAppIconCandidates:(CDUnknownBlockType)arg1;
- (id)pathForPrimaryAppIconSetContents:(id)arg1 platform:(id)arg2;
- (BOOL)assetCatalogIdiom:(id)arg1 isCompatibleWithPlatform:(id)arg2 andDeviceFamilies:(id)arg3;
- (id)versionSettings;
