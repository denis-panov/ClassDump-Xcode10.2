...
@class DYCaptureSessionInfo, GPUDebuggingAdditionUIController, GPUTraceDocumentExportController, GPUTraceProcessItem, GPUTraceSession, GPUTraceStorage, NSArray, NSString;

@interface GPUTraceDocument : IDEEditorDocument <IDEDocumentStructureProviding>
{
    GPUTraceDocumentExportController *_exportController;
