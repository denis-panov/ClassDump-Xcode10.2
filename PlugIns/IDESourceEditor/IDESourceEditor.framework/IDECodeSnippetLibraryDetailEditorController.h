...
@class DVTStackView_ML, IDECodeLibraryDetailController, IDECodeSnippet, NSArray, NSMutableArray;
...
@property(retain) IDECodeLibraryDetailController *currentDetailController; // @dynamic currentDetailController;
