...
@interface _TtC15IDESourceEditor19IDESourceEditorView : _$s15DVTSourceEditor0aB4ViewCN <DVTSourceEditorViewProtocol, DVTTextCompletionSupportingTextView, DVTMarkedScrollerDelegate>
{
    ...
    // Error parsing type: , name: isCurrentlyDoingNonUserEditing
...
@property(nonatomic) BOOL currentlyDoingNonUserEditing; // @synthesize currentlyDoingNonUserEditing=isCurrentlyDoingNonUserEditing;
