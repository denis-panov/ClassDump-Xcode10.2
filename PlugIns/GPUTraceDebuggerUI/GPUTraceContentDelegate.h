...
@interface GPUTraceContentDelegate : NSObject <DVTFilterTokenFieldControllerDelegate, IDEDebugNavigableContentDelegate, DVTInvalidation>
{
    ...
    id <NSObject> _debuggerControllerShaderDebuggerSessionDidChangeObserver;
    id <NSObject> _shaderDebuggerSessionSelectedThreadDidChangeObserver;
...
- (void).cxx_destruct;
- (id)_createGPUGaugeLocationIfNeeded:(id)arg1;
- (id)_createFPSGaugeLocationIfNeeded:(id)arg1;
...
- (void)_setHideProgramMetricsDifference:(id)arg1;
- (void)_setShowProgramMetricsDifference:(id)arg1;
...
- (id)filterView;
- (void)_updateFilterTokensAndCompletionsForOutlineMode;
