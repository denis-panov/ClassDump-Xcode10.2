...
@class DVTDisclosureView, DVTObservingToken, IBButtonComboBox, IBCocoaBindingsAutocompletingTextField, IBCocoaBindingsBindingInfo, IBCocoaBindingsInspector, IBDocument, NSArray, NSBox, NSMutableArray, NSObjectController, NSOperationQueue, NSString, NSTextField;
@protocol DVTCancellable, IBCocoaBindingsInspectorSliceDelegate;

@interface IBCocoaBindingsInspectorSlice : IDEViewController <NSMenuDelegate>
{
    ...
    IBCocoaBindingsInspector *_inspector;
    BOOL _bound;
    ...
    id <IBCocoaBindingsInspectorSliceDelegate> _delegate;
}
