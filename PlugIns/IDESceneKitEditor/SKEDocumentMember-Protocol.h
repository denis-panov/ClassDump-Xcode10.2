...
#import <IDESceneKitEditor/IDEInspectorMatching-Protocol.h>
#import <IDESceneKitEditor/IDEKeyDrivenNavigableItemRepresentedObject-Protocol.h>
#import <IDESceneKitEditor/SKEDocumentMemberMutationDelegate-Protocol.h>

@class IDEEditorDocument, IDETypeIdentifier, NSArray, NSImage, NSString, SKEDocumentLocation;
