...
- (void)flattenNodes:(id)arg1;
- (void)duplicateNodes:(id)arg1;
- (void)deleteNodes:(id)arg1;
- (void)unhideNodes:(id)arg1;
- (void)hideNodes:(id)arg1;
- (void)addMenuItemsToMenu:(id)arg1 contextual:(BOOL)arg2;
- (void)createMagneticField:(id)arg1;
- (void)createElectricField:(id)arg1;
- (void)createSpringField:(id)arg1;
- (void)createTurbulenceField:(id)arg1;
- (void)createNoiseField:(id)arg1;
- (void)createLinearGravityField:(id)arg1;
- (void)createRadialGravityField:(id)arg1;
- (void)createVortexField:(id)arg1;
- (void)createDragField:(id)arg1;
- (void)createParticleSystem:(id)arg1;
- (void)createText:(id)arg1;
- (void)createFloor:(id)arg1;
- (void)createTorus:(id)arg1;
- (void)createCapsule:(id)arg1;
- (void)createTube:(id)arg1;
- (void)createCone:(id)arg1;
- (void)createCylinder:(id)arg1;
- (void)createPyramid:(id)arg1;
- (void)createGeodesicSphere:(id)arg1;
- (void)createSphere:(id)arg1;
- (void)createBox:(id)arg1;
- (void)createPlane:(id)arg1;
- (void)createIESLight:(id)arg1;
- (void)createLightProbe:(id)arg1;
- (void)createAmbientLight:(id)arg1;
- (void)createSpotLight:(id)arg1;
- (void)createDirectionalLight:(id)arg1;
- (void)createOmniLight:(id)arg1;
- (void)createOrthographicCamera:(id)arg1;
- (void)createPerspectiveCamera:(id)arg1;
- (void)createNode:(id)arg1;
- (void)_loadSplitViewStateFromDefaults;
...
- (BOOL)canTakeFreeCameraParameters;
