...
+ (id)keyPathsForValuesAffectingide_sky_highDynamicRangeCompression_edit;
...
- (void)setide_sky_highDynamicRangeCompression_edit: /* Error: Ran out of types for this method. */;
-     // Error parsing type: 16@0:8, name: ide_sky_highDynamicRangeCompression_edit
