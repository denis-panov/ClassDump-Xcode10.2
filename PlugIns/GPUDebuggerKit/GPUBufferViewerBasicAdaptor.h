...
@interface GPUBufferViewerBasicAdaptor : NSObject <GPUBufferViewerAdaptor>
{
    ...
    NSString *_name;
    NSArray *_markers;
    vector_d2e2fb42 _dataBuffers;
    vector_56802008 _encodedResourceMaps;
...
@property(nonatomic) vector_56802008 encodedResourceMaps; // @synthesize encodedResourceMaps=_encodedResourceMaps;
@property(nonatomic) vector_d2e2fb42 dataBuffers; // @synthesize dataBuffers=_dataBuffers;
...
- (id)initWithName:(id)arg1 dataStruct:(const struct Struct *)arg2 dataBuffers:(const vector_d2e2fb42 *)arg3;
