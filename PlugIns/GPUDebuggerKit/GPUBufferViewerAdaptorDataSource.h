...
@protocol GPUBufferViewerAdaptor, GPUBufferViewerDataSourceProvider, GPUBufferViewerElement;

__attribute__((visibility("hidden")))
@interface GPUBufferViewerAdaptorDataSource : NSObject <GPUBufferViewerDataSource>
{
    BOOL _supportsOffset;
    BOOL _supportsUnorderedRowColumns;
...
- (BOOL)processStruct:(const struct Struct *)arg1 withBuffers:(const vector_d2e2fb42 *)arg2;
