...
@class CDMFetchIndex, DVTStackBacktrace, IDEDataModelEditor, IDEDataModelFetchIndexEditor, NSArrayController, NSColor, NSImage, NSIndexSet, NSString, NSTableColumn, XDTableView;
