...
#import <IDESourceCodeComparisonEditor/DVTComparisonSplitViewDelegate-Protocol.h>
#import <IDESourceCodeComparisonEditor/DVTDiffSessionDelegate-Protocol.h>
#import <IDESourceCodeComparisonEditor/IDEComparisonEditorDelegate-Protocol.h>
#import <IDESourceCodeComparisonEditor/IDEComparisonEditorSavableMergeState-Protocol.h>
#import <IDESourceCodeComparisonEditor/IDESourceEditorViewControllerHost-Protocol.h>
#import <IDESourceCodeComparisonEditor/NSSplitViewDelegate-Protocol.h>

@class DVTBorderedView, DVTComparisonScrollCoordinator, DVTComparisonSplitView, DVTDiffSession, DVTNotificationToken, DVTObservingToken, DVTSourceTextView, IDEEditor, IDEEditorDocument, IDESourceCodeDocument, IDESourceCodeVersionsLayoutView, IDESourceControlMergeData, NSDictionary, NSString, _TtC29IDESourceCodeComparisonEditor18TwoUpVisualization;
...
@interface IDESourceCodeVersionsTwoUpSubmode : IDEComparisonEditorSubmode <IDEComparisonEditorDelegate, NSSplitViewDelegate, IDESourceEditorViewControllerHost, DVTDiffSessionDelegate, DVTComparisonSplitViewDelegate, IDEComparisonEditorSavableMergeState>
{
    ...
    _TtC29IDESourceCodeComparisonEditor18TwoUpVisualization *_twoUpVisualization;
...
- (id)keyEditorTextView;
- (id)secondaryComparisonTextView;
- (id)primaryComparisonTextView;
- (id)keyEditor;
