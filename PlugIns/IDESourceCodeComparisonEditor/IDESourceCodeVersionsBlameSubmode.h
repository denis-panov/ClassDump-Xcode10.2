...
@class DVTBorderedView, DVTNotificationToken, DVTObservingToken, DVTSourceTextView, IDEEditor, IDESourceCodeBlameController, NSDictionary, NSProgressIndicator, NSString, NSView, _TtC29IDESourceCodeComparisonEditor29BlameAnnotationsVisualization;
...
@interface IDESourceCodeVersionsBlameSubmode : IDEComparisonEditorSubmode <IDEComparisonEditorDelegate, IDESourceEditorViewControllerHost, IDESourceCodeBlameControllerDelegate>
{
    ...
    _TtC29IDESourceCodeComparisonEditor29BlameAnnotationsVisualization *_blameVisualization;
...
- (id)standardPlaceholderWithText:(id)arg1 fallbackText:(id)arg2 maximumWidth:(double)arg3;
