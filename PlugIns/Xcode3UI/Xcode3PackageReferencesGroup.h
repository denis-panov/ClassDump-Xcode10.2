...
@class DVTDocumentLocation, DVTFileDataType, DVTStackBacktrace, IDEFileReference, NSArray, NSImage, NSNull, NSString, NSURL, Xcode3Project, _TtC13DVTFoundation9DVTSymbol;

@interface Xcode3PackageReferencesGroup : DVTModelObject <DVTInvalidation, IDEKeyDrivenNavigableItemRepresentedObject>
{
