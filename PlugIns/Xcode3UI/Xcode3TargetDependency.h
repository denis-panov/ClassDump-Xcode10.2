...
@class DVTDocumentLocation, DVTFileDataType, IDEFileReference, NSArray, NSImage, NSNull, NSString, NSURL, Xcode3BuildFileGroup, Xcode3BuildPhase, _TtC13DVTFoundation9DVTSymbol;
