...
@class DVTBorderedView, DVTObservingToken, DVTTableView, IDENavigableItem, IDENavigableItemCoordinator, NSArray, NSColor, NSImage, NSString, Xcode3PackageAddPackageAssistantWindowController, Xcode3PackageReferencesGroup, Xcode3Project;
