...
#import <Xcode3UI/IDEProvisioningSettingsTargetEditorViewControllersManagerSource-Protocol.h>
#import <Xcode3UI/Xcode3SourceListItemEditor-Protocol.h>

@class DVTObservingToken, DVTPlatform, DVTSourceExpression, DVTStackView_ML, IDEContainerQuery, NSArray, NSMutableDictionary, NSString, PBXNativeTarget, Xcode3CodesignTroubleshootingViewController, Xcode3ProjectEditor, Xcode3TargetInfoPlistCoordinator;
@protocol DVTInvalidation, IDEBlueprint, IDEProvisionable, IDEProvisioningStyleDataSourceProvider;

@interface Xcode3TargetEditor : IDEViewController <Xcode3SourceListItemEditor, IDEProvisioningSettingsTargetEditorViewControllersManagerSource>
{
...
+ (id)keyPathsForValuesAffectingProvisioningStyleDataSourceProvider;
...
- (void).cxx_destruct;
@property(readonly) id <IDEProvisioningStyleDataSourceProvider> provisioningStyleDataSourceProvider;
