...
#import <IDEIODebugGaugesCore/IDEDebuggingAddition-Protocol.h>

@class DVTObservingToken, DVTStackBacktrace, IDEDebugSession, IDEGaugeDataQuery, IDELaunchSession, NSMutableArray, NSString;
