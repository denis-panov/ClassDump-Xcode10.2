...
@property(retain) NSString *nextBootArgs; // @synthesize nextBootArgs=_nextBootArgs;
...
- (void)setPresumedRemoteAddress:(id)arg1;
...
- (id)_executeFetchNextBootArgsCommand;
...
- (void)hasConnected;
- (void)_hasAdoptedConformingDeviceType;
- (void)_adoptConformingDeviceType;
...
- (CDUnknownBlockType)_analysisOperationWithAnalysisToolService:(id)arg1 location:(id)arg2 workingDirectory:(id)arg3 workspaceFilePath:(id)arg4 projectFilePath:(id)arg5 packagesPaths:(id)arg6 outError:(id *)arg7;
