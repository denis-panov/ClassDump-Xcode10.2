...
@class IDEPlaygroundPageSharedContext, IDEPlaygroundSharedContext, IDEToybox, NSArray, NSMutableArray, NSString;
...
@interface _TtC26IDEPegasusPlaygroundEditor18PlaygroundDocument : _$s15IDESourceEditor18SourceCodeDocumentCN <IDEPlaygroundHostingDocument, IDEPlaygroundExecutionSessionDelegate, IDEToyboxDelegate, IDEPlaygroundExecutionDeviceViewContentReceiver>
{
    ...
    // Error parsing type: , name: executionRanges
    // Error parsing type: , name: stashedExecutionRanges
    // Error parsing type: , name: expressionStopwatch
    ...
    // Error parsing type: , name: _auxiliarySourceFrameworks
    // Error parsing type: , name: lastExecutedLineContent
    // Error parsing type: , name: skipCancelExecutionOnNextEdit
