...
@class DVTObservingToken, DVTStackBacktrace, DYCaptureArchive, DYCaptureSession, DYCaptureSessionInfo, DYFuture, DYGuestAppSession, DYProgressDigest, GPUCaptureMessage, GPUDebuggerController, GPUTraceSession, IDELaunchSession, NSDate, NSError, NSMutableArray, NSMutableDictionary, NSString;
...
- (unsigned long long)_estimatedTraceSessionSetupDurationSecondsForArchive:(id)arg1;
...
- (void)_logCaptureComplete:(BOOL)arg1 withError:(id)arg2;
