...
@interface GPUDebuggerController : NSObject <DVTInvalidation, DYShaderProfilerDelegate, DYPDebuggerControllerProxyDelegate, GPUPerformanceDataProvider>
{
    ...
    GPUDebuggerDependencyViewerTextureCache *_dependencyViewerCache;
...
@property(readonly) GPUDebuggerDependencyViewerTextureCache *dependencyViewerCache; // @synthesize dependencyViewerCache=_dependencyViewerCache;
...
- (void)_restartShaderDebugger:(CDUnknownBlockType)arg1;
...
- (id)_profileShaders:(unsigned long long)arg1 progressDigest:(id)arg2;
- (id)_profileFrame:(unsigned long long)arg1 progressDigest:(id)arg2;
...
- (void)archiveShaderProfilerResultData;
