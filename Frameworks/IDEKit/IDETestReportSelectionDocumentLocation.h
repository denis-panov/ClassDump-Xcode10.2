...
@protocol IDETestReport_Test, IDETestReport_TestActivity, IDETestReport_TestAttachment, IDETestReport_TestRun;
...
- (id)initWithDocumentURL:(id)arg1 test:(id)arg2 ide_test:(id)arg3 testRun:(id)arg4 activity:(id)arg5 attachment:(id)arg6 attachmentsHaveBeenPruned:(BOOL)arg7;
