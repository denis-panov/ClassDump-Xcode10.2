...
@interface IDETestReportDiagnosticAssistantNavigableItemGroup : NSObject <IDEKeyDrivenNavigableItemRepresentedObject>
{
...
+ (void)initialize;
- (void).cxx_destruct;
- (id)itemForFileURL:(id)arg1 logRecordIdentifier:(id)arg2 testIdentifier:(id)arg3 diagnosticLogPaths:(id)arg4 invocationRecord:(id)arg5 inWorkspace:(id)arg6;
