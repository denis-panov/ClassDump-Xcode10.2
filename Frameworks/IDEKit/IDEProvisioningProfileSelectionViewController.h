...
@class DVTObservingToken, IDEProvisioningProfileDisplayGroup, IDEProvisioningProfileDownloaderWindowViewController, IDEProvisioningSliceConfiguration, NSButton, NSLayoutConstraint, NSOrderedSet, NSPopUpButton, NSPopover, NSString, NSTextField;
@protocol IDEProvisioningProfileSelectionDataSource;

@interface IDEProvisioningProfileSelectionViewController : IDEViewController <NSPopoverDelegate, NSMenuDelegate>
{
    id <IDEProvisioningProfileSelectionDataSource> _dataSource;
...
@property(retain, nonatomic) id <IDEProvisioningProfileSelectionDataSource> dataSource; // @synthesize dataSource=_dataSource;
- (void).cxx_destruct;
