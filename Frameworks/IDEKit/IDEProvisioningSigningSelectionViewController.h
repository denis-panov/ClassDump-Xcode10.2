...
@class DVTObservingToken, IDEProvisioningSliceConfiguration, NSButton, NSLayoutConstraint, NSPopUpButton, NSString, NSTextField;
@protocol IDEProvisioningSigningCertificateSelectionDataSource;

@interface IDEProvisioningSigningSelectionViewController : IDEViewController <NSMenuDelegate>
{
    id <IDEProvisioningSigningCertificateSelectionDataSource> _dataSource;
    NSPopUpButton *_signingIdentityPopUpButton;
    NSTextField *_signingIdentityLabel;
    NSTextField *_signingIdentityPopUpLabel;
    NSButton *_developmentSigningButton;
...
@property(retain) NSButton *developmentSigningButton; // @synthesize developmentSigningButton=_developmentSigningButton;
...
@property(retain, nonatomic) id <IDEProvisioningSigningCertificateSelectionDataSource> dataSource; // @synthesize dataSource=_dataSource;
- (void).cxx_destruct;
- (void)primitiveInvalidate;
- (void)enableDevelopmentSigning:(id)arg1;
