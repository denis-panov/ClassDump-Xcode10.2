...
+ (void)_openNavigationHUDSelection:(id)arg1 forWorkspaceDocument:(id)arg2 documentURL:(id)arg3 client:(unsigned long long)arg4 usingBlock:(CDUnknownBlockType)arg5;
+ (void)_openNavigationHUDSelection:(id)arg1 forWorkspaceDocument:(id)arg2 client:(unsigned long long)arg3 usingBlock:(CDUnknownBlockType)arg4;
...
+ (void)_doOpenEditorOpenSpecifier:(id)arg1 forWorkspaceTabController:(id)arg2 editorContext:(id)arg3 target:(int)arg4 takeFocus:(int)arg5 client:(unsigned long long)arg6;
+ (void)_shouldNavigateAwayFromEditorContext:(id)arg1 block:(CDUnknownBlockType)arg2;
+ (void)_doOpenWithWorkspaceTabController:(id)arg1 editorContext:(id)arg2 target:(int)arg3 allowFallback:(BOOL)arg4 documentURL:(id)arg5 client:(unsigned long long)arg6 usingBlock:(CDUnknownBlockType)arg7;
...
+ (void)_doOpenIn_Ask_withWorkspaceTabController:(id)arg1 editorContext:(id)arg2 documentURL:(id)arg3 initialSelection:(id)arg4 options:(id)arg5 client:(unsigned long long)arg6 usingBlock:(CDUnknownBlockType)arg7;
