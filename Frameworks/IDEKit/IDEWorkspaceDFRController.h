...
@class DVTObservingToken, DVTStackBacktrace, IDEWorkspaceDFRDebugBarItemFactory, IDEWorkspaceWindowController, NSButton, NSPointerArray, NSPopoverTouchBarItem, NSString;
