...
@class DVTDocumentLocation, DVTFileDataType, IDEActivityLogObservableRecord, IDEActivityLogRecord, IDEEntityIdentifier, IDEFileReference, IDELogNavigatorGroupedSchemeItemsCache, IDEWorkspace, NSArray, NSImage, NSNull, NSString, NSURL, _TtC13DVTFoundation9DVTSymbol;
...
- (id)_buildLogIcon;
- (id)_urlForTimelineInRecord:(id)arg1;
