...
@class DVTPlatform, DVTPortalProfileType, DVTProvisioningProfile, DVTSigningCertificateManager, IDEAppIDFeatures, IDEQualifiableProfileQualification, NSArray, NSDictionary, NSError, NSSet, NSString;
...
@property(copy, nonatomic) IDEAppIDFeatures *features; // @synthesize features=_features;
