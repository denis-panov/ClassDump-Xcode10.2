...
- (void)openIndex:(id)arg1 workspaceFile:(id)arg2 indexFolder:(id)arg3 datastoreFolder:(id)arg4 databaseFolder:(id)arg5 pchHeaderFolder:(id)arg6 buildConfig:(id)arg7 destinationTargetIdentifier:(id)arg8 indexDatabasePath:(id)arg9 toolchainInvocationLoggingPath:(id)arg10 enableFullStoreVisibility:(id)arg11 dumpIndexables:(id)arg12 initialDBSize:(id)arg13 queue:(id)arg14 completion:(CDUnknownBlockType)arg15;
- (id)openIndex:(id)arg1 workspaceFile:(id)arg2 indexFolder:(id)arg3 datastoreFolder:(id)arg4 databaseFolder:(id)arg5 pchHeaderFolder:(id)arg6 buildConfig:(id)arg7 destinationTargetIdentifier:(id)arg8 indexDatabasePath:(id)arg9 toolchainInvocationLoggingPath:(id)arg10 enableFullStoreVisibility:(id)arg11 dumpIndexables:(id)arg12 initialDBSize:(id)arg13 error:(id *)arg14;
...
- (void)setEnableCompileNotifications:(BOOL)arg1 queue:(id)arg2 completion:(CDUnknownBlockType)arg3;
