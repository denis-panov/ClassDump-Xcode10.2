...
@class IDEProvisionableEntitlements, NSArray, NSDictionary, NSString;
...
@interface IDEExtendedPlatformInfo : NSObject
{
    ...
    BOOL _wantsAppStoreSubmissionConfigurationSupport;
    BOOL _allowsRelaxationOfStrictBitcodeAndPlatformChecks;
    BOOL _swinfoSupportsUncompressedPackage;
...
@property(readonly) BOOL swinfoSupportsUncompressedPackage; // @synthesize swinfoSupportsUncompressedPackage=_swinfoSupportsUncompressedPackage;
@property(readonly) NSString *swinfoPlatformArgument; // @synthesize swinfoPlatformArgument=_swinfoPlatformArgument;
...
@property(readonly) BOOL wantsAppStoreSubmissionConfigurationSupport; // @synthesize wantsAppStoreSubmissionConfigurationSupport=_wantsAppStoreSubmissionConfigurationSupport;
...
@property(readonly) IDEProvisionableEntitlements *baseEntitlements; // @synthesize baseEntitlements=_baseEntitlements;
