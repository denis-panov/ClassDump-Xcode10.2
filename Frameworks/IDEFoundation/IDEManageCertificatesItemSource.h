...
@class DVTDelayedInvocation, DVTPortalCertificate, DVTStackBacktrace, IDEManageCertificatesContext, IDEManageCertificatesItemCollection, NSError, NSSet, NSString;
...
@interface IDEManageCertificatesItemSource : NSObject <DVTInvalidation>
{
    ...
    id <DVTInvalidation> _certManagerToken;
