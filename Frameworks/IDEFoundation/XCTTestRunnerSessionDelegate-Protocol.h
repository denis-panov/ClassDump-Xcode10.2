...
- (void)testRunnerSessionDidFinishExecutingTests:(XCTTestRunnerSession *)arg1 reply:(void (^)(void))arg2;
- (void)testRunnerSessionDidStartExecutingTests:(XCTTestRunnerSession *)arg1;
- (void)testRunnerSession:(XCTTestRunnerSession *)arg1 didFailToBootstrapWithError:(NSError *)arg2;
