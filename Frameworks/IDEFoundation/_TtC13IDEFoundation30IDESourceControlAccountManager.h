...
@interface _TtC13IDEFoundation30IDESourceControlAccountManager : NSObject <DVTSourceControlAccountManager>
{
    ...
    // Error parsing type: , name: accountsRepositoriesOperationQueue
    // Error parsing type: , name: shouldLoadAccounts
    // Error parsing type: , name: credentialsManager
    // Error parsing type: , name: accountsQueuedForRehydration
    ...
    // Error parsing type: , name: accountMigrator
...
@property(nonatomic, copy) NSArray *accountsQueuedForRehydration; // @synthesize accountsQueuedForRehydration;
