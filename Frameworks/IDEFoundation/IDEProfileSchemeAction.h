...
- (id)primitiveProfileOperationForRunnableType:(id)arg1 runDestination:(id)arg2 launchParametersProvider:(CDUnknownBlockType)arg3 workspaceFilePath:(id)arg4 projectFilePath:(id)arg5 schemeCommand:(id)arg6 outError:(id *)arg7;
