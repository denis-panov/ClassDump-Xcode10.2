...
+ (id)itemWithIdentifier:(id)arg1 fileNameComponent:(id)arg2 title:(id)arg3 multiple:(double)arg4 coreUIScale:(long long)arg5 displayOrder:(double)arg6 deprecated:(BOOL)arg7;
...
- (id)initWithIdentifier:(id)arg1 fileNameComponent:(id)arg2 title:(id)arg3 multiple:(double)arg4 coreUIScale:(long long)arg5 displayOrder:(double)arg6 deprecated:(BOOL)arg7;
- (long long)componentID;
